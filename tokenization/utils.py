...
def get_special_tokens():
    return {
        'additional_special_tokens': [NODE_LABEL, EDGE_START, EDGE_END, NODE_SEP, NODE_PATH_SEP]
    }


def get_tokenizer(model_name, special_tokens=None, max_length=512) -> AutoTokenizer:
